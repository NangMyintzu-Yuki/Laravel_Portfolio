    ...
    <div class="container-fluid px-4">
        ...
        <div class="row">
            <div class="col-md-6">
                <ol class="breadcrumb mb-4">
                    ...
                    <li class="breadcrumb-item active"><a href="" class="text-success">Edit Member</a></li>
                </ol>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-7 mx-auto">
                ...
                @endif
                <form action="" wire:submit.prevent="updateMember" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group mb-3">
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                <input type="file" name="author_profile" class="form-control" wire:model="new_profile">
                                @if($new_profile)
                                 <img src="{{ $new_profile->temporaryUrl() }}" width="80px" alt="">
                                @else
                                    <img src="{{ asset('assets/images/member_profile') }}/{{ $author_profile }}" width="80px" alt="">
                                @endif
                                @error('new_profile')
                                    <p class="validate-error alert ">{{ $message }}</p>
                                @enderror
