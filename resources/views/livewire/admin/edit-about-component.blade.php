    ...
    <div class="container-fluid px-4">
        ...
        <div class="row">
            <div class="col-md-6">
                <ol class="breadcrumb mb-4">
                    ...
                    <li class="breadcrumb-item active"><a href="#" class="text-success">Edit About</a></li>
                </ol>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-7 mx-auto">
                ...
                @endif
                <form action="#" wire:submit.prevent="editAbout" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group mb-3">
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                <input type="file" name="profile" class="form-control" wire:model="new_profile">
                                @if($new_profile)
                                    <img src="{{ $new_profile->temporaryUrl() }}" width="80px" alt="">
                                @else
                                    <img src="{{ asset('assets/images/my_profile') }}/{{ $profile }}" width="80px" alt="">
                                @endif
                                @error('new_profile')
                                    <p class="validate-error alert ">{{ $message }}</p>
                                @enderror
