    ...
    <div class="container-fluid px-4">
        ...
        <div class="row">
            <div class="col-md-6">
                <ol class="breadcrumb mb-4">
                    ...
                    <li class="breadcrumb-item"><a href="#" class="text-success">Edit Dashboard</a></li>
                </ol>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-7 mx-auto">
                ...
                @endif
                <form action="" wire:submit.prevent="updateDashboard" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group mb-3">
                        <div class="row">
                            ...
                            <div class="col-md-7">
                                ...
                                @else
                                 <img src="{{ asset('assets/images/dashboard') }}/{{ $image }}" width="80px" alt="">
                                @endif
                                @error('newimage')
                                    <p class="validate-error alert ">{{ $message }}</p>
                                @enderror
