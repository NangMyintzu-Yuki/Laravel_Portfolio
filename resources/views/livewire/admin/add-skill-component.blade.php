    ...
    <div class="container-fluid px-4">
        ...
        <div class="row">
            <div class="col-md-6">
                <ol class="breadcrumb mb-4">
                    ...
                    <li class="breadcrumb-item active"><a href="{{ route('admin.addskill') }}" class="text-success">Add Skill</a></li>
                </ol>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-7 mx-auto">
                ...
                @endif
                <form action="" wire:submit.prevent="CreateSkill" enctype="multipart/form-data">
                    @csrf
